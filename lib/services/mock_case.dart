// Mock Case Data ("Case Alpha" - Bank Robbery Heist) for Flutter

class MockCaseData {
  static const String caseName = "Case Alpha: Downtown Bank Vault Heist";
  static const String dateOfOccurrence = "2026-06-10";
  static const String description = 
      "Armed robbery of \$2.4M cash transit at Downtown Bank Vault on June 10, 2026 at 14:30. Getaway car spotted fleeing north via Highway 4.";

  // Raw CDR Call detail records CSV
  static const String cdrCsv = """Timestamp,Caller,Recipient,Duration_Sec,Type,Cell_Tower_ID,IMEI,IMSI
...
2026-06-10 18:05:44,+1-555-0102,+1-555-0199,10,Voice,TWR-NorthSuburb-12,IMEI-112233,IMSI-40402""";
  ...
  // Mock Tower Dump datasets (TDR)
  static final List<Map<String, dynamic>> tdrTowers = [
    {
      "id": "TWR-Downtown-01",
...
2026-06-10 16:15:40,+1-555-0199,IMSI-40401,-59"""
  ...
  // Geolocation registry for tower IDs
  static final Map<String, Map<String, dynamic>> towerRegistry = {
  ...
  // SDR Registered profiles
  static final List<Map<String, dynamic>> sdrDatabase = [
    {
      "phone": "+1-555-0199",
      "name": "John Doe",
      "age": "42",
